...
//
//	mockgen -source=./repository.go -destination=./mock/repository_mock.go -package=port
//
...
func (m *MockRateLimiterRepository) Allow(ctx context.Context, key string, limit int, duration time.Duration) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRateLimiterRepositoryMockRecorder) Allow(ctx, key, limit, duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Allow", reflect.TypeOf((*MockRateLimiterRepository)(nil).Allow), ctx, key, limit, duration)
}
